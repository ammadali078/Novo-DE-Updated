...
class EduDoctorViewController: UIViewController {
    ...
    var DoctorListDataSource: EduDoctorListCell!
    var plannedDoctorListDataSource: EduPlannedDoctorListCell!
    var delegate3: (([DoctorResult]) -> Void)? = nil
    var delegate4: (([Msrplan]) -> Void)? = nil
    ...
    override func viewDidLoad() {
        ...
        DoctorListDataSource = EduDoctorListCell()
        ...
        plannedDoctorListDataSource = EduPlannedDoctorListCell()
